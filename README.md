...
relational database is a collection of data with predefined relationships which is organized into tables(rows & collums)
sql is the language we use to manage the data in a relational database

2. Why do tables need a `primary key`?
to uniquely identify each row, prevent redundancies

3. What is the name given to a table column that references the primary key on another table.
foreign key

4. What do we need in order to have a _many to many_ relationship between two tables.
we need a 3rd table to manage the transactions & relationships between the 2 tables
